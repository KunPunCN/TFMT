...
class ASTE(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        outputs = self(**batch)
        loss = outputs['table_loss_S'] + outputs['table_loss_E'] + outputs['pair_loss']# + outputs['em_loss']
    ...
    def validation_step(self, batch, batch_idx):
        ...
        return {
            ...
            # 'all_preds': outputs['all_preds'],# NOTE 用于计算Classification的迁移能力
        }
    ...
    def test_epoch_end(self, outputs):
        ...
        # NOTE 用于计算Classification的迁移能力
        # self.test_result = Result.parse_from_cls(outputs, examples)
