                ...
                while line:
                    ...
                    for i in tgt_text:
                        ...
                        if c == '\'POS\'':
                            ...
                            label = 'NEU'
                        aspect[label] = aspect[label] + '; ' + a  # 使用分号分组
                    ...
                    for i, l in enumerate(['POS', 'NEG', 'NEU']):
                        ...
                        if aspect[l].split('; ')[1:] != [] and term[l].split('; ')[1:] != []:
                            label_pair = syn_matix(text_a.split(' '), tgt_text, tokenizer, label_pair, l)
                    ...
                    input_example["tokens"] = tokenizer.convert_ids_to_tokens(tokenizer(text_a, add_special_tokens=False)['input_ids'])
